...
const EXPERT_KNOWLEDGE = {
  ...
  responses: {
    ...
    academy: "The Hayzed Fashion Academy offers an intensive 3-Month Program to master Men's Native Wear (Senator & Kaftan construction, Pattern Drafting, and finishing). Classes start August 10th, 2026 in Ilorin, Kwara State. The fee is ₦250,000 (Early Bird ₦200,000 for the first 5 applicants).",
